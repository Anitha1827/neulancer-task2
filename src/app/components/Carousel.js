...
export default function Carousel() {
  ...
  return (
    <div className="w-screen h-[1200px] xl:h-[600px] shrink-0 bg-[url('https://expertbuildcare.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FheroBG.b8b59c9b.png&w=1920&q=75')] bg-no-repeat bg-cover">
